...
LEFT_GRIPPER_MOTOR_NAME = LEFT_HARDWARE_MOTOR_NAMES[-1]
RIGHT_GRIPPER_MOTOR_NAME = RIGHT_HARDWARE_MOTOR_NAMES[-1]
LEFT_ARM_MOTOR_NAMES = LEFT_HARDWARE_MOTOR_NAMES[:-1]
RIGHT_ARM_MOTOR_NAMES = RIGHT_HARDWARE_MOTOR_NAMES[:-1]
