...
def run_mujoco() -> None:
    ...
    run_silently(lambda: main(push_eetarget=False), "mujoco")
...
def run_hommi() -> None:
    from g7_openarm_hommi.hommi_node import main

    run_silently(lambda: main("simulation"), "hommi")
...
def main() -> None:
    ...
    processes = [
        ...
        ctx.Process(target=run_hommi, name="g7-hommi"),
    ]
